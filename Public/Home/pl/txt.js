...
$(document).ready(function(){
	...
	circle("mercury",$width*0.25,centerpointW,centerpointH);
	docircle("mercury",$width*0.25,centerpointW,centerpointH);
	circleimg("mercury");
	
	circle("venus",$width*0.40,centerpointW,centerpointH);
	docircle("venus",$width*0.4,centerpointW,centerpointH);
	circleimg("venus");
	
	circle("earth1",$width*0.55,centerpointW,centerpointH);
	docircle("earth1",$width*0.55,centerpointW,centerpointH);
	circleimg("earth1");
	...
	circle("y1",$width*0.90,centerpointW,centerpointH);
	circle("y2",$width*0.6,centerpointW,centerpointH);
