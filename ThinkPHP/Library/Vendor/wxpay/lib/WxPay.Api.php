...
class WxPayApi
{
	...
	/**
	 * 企业付款
	 * @param WxPayment $inputObj
	 * @param int $timeOut
	 * @return array
	 * @throws WxPayException
	 */
	public static function payment($inputObj, $timeOut = 6){
		...
		$inputObj->SetSpbillCreareIp($_SERVER['REMOTE_ADDR']);//终端ip
	...
	/**
	 * 获取APP端签了名的请求
	 * @param WxPayRequest $inputObj
	 * @return array
	 */
	public static function getSignRequest($inputObj){
