...
//------------------------------------------------------用户体系	
	...
	public function __construct($options) {
		$this->client_id = isset ( $options ['client_id'] ) ? $options ['client_id'] : 'YXA6e9eDkJAlEea3kdW_GIYeaQ';
		$this->client_secret = isset ( $options ['client_secret'] ) ? $options ['client_secret'] : 'YXA6iMjFPoyBmILeWWWy0qg1u4dHhb0';
		$this->org_name = isset ( $options ['org_name'] ) ? $options ['org_name'] : '3538135319';
		$this->app_name = isset ( $options ['app_name'] ) ? $options ['app_name'] : 'zhenzhong';
